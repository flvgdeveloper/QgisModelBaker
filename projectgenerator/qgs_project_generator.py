...
from projectgenerator.gui.import_data import DataImportDialog
...
class QgsProjectGeneratorPlugin(QObject):
    ...
    def initGui(self):
        ...
        self.__dataimport_action = QAction(self.tr('Data Import'), None)
        ...
        self.__dataimport_action.triggered.connect(self.show_dataimport_dialog)
        ...
        self.iface.addPluginToDatabaseMenu(self.tr('Project Generator'), self.__dataimport_action)
    ...
    def unload(self):
        ...
        self.iface.removePluginDatabaseMenu(self.tr('Project Generator'), self.__dataimport_action)
    ...
    def show_dataimport_dialog(self):
        dlg = DataImportDialog(self.ili2db_configuration)
        dlg.exec_()
