...
from ..libili2pg import iliexporter
...
class ExportDialog(QDialog, DIALOG_UI):
    ...
    def updated_configuration(self):
        ...
        """
        configuration = iliexporter.Configuration()
        ...
        configuration.xtffile = self.xtf_file_line_edit.text()
        configuration.ilifolder = self.ili_folder_line_edit.text()
        configuration.ilimodels = self.ili_model_line_edit.text()
